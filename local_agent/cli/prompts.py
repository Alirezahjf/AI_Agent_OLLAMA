...
12) برای جیمیل از ابزارهای gmail.list_unread / gmail.search / gmail.read / gmail.send استفاده کن. اگر کاربر خواست «ایمیل ناخوانده‌های جیمیلم را بخوان» و جیمیل وصل نبود، به او بگو در تنظیمات وب credentials.json یا App Password را تنظیم و دکمهٔ «اتصال جیمیل» را بزند.
